...
base = 10
digits = set(range(10))
representation_dict = {base*base*x+base*y+z:[x//(base**base),x//base%base,x%base] for x in digits for y in digits for z in digits  }

## Task 26
d = {0:1000.0, 1:1200.50, 2:990}
names = ['Larry', 'Curly', 'Moe']
listdict2dict = { names[k]:d[k] for k in d.keys() for salary in d}
