...
sum_to_zero_1 = [0,one,0,one,one]    #[1,3,4,6]
sum_to_zero_2 = [0,one,0,one,one,0,0]#[2,4,5]
sum_to_zero_3 = [one,0,one,one,one]  #[1,3,4,6]
sum_to_zero_4 = [one,one,one,one,one,0,0] #[1,2,3,5,6]
...
def exchange(S, A, z):
    ...
    for i,v in enumerate(T):
        if is_superfluous(T,i) and v not in A and v!=z:
            return v
