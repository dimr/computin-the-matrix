...
def fraction_wrong(A, b, w):
    ...
    '''
    xx=signum(A*w)
    x=[i*j for i,j in zip(list(xx.f.values()),list(b.f.values()))]
    counts=sum(i<0 for i in x)
    return counts/len(xx.D)
...
def find_grad(A, b, w):
    ...
    '''
    t=A*w-b
    return Vec(t.D,{k:t.f[k]**2 for k in t.f.keys()})
